...
import girl from "../assets/girk.svg";
...
import xx59 from "../assets/xx59De.svg";
      ...
      <div>
        ...
        <div className="img-side flex ml-[220px] mt-[399px]">
          ...
          <div className="secound-side ">
            <img src={hand} className="pl-8 " alt="" />
          </div>
        </div>
            ...
            <div>
              <div className="w-[350px] mt-[64px] h-[318px] bg-[#F1F1F1] rounded-xl">
                <img
                  src={tho}
                  alt=""
                  className="translate-x-20 translate-y-16 w-[180px] h-[200px]"
                />
              </div>
